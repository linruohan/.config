! function(e) {
    ...
    function e(r, n) {
        if (!(this instanceof e))
            return new e(r, n);
        this.options = n = n ? Io(n) : {},
            Io(_l, n, !1),
            d(n);
        var i = n.value;
        "string" == typeof i && (i = new ms(i, n.mode)),
            this.doc = i;
        ...
        dl && 11 > pl && setTimeout(function() {
            ...
            Xi(this, i),
            n.autofocus && !Sl || a.hasFocus() ? setTimeout(Po(dn, this), 20) : pn(this);
        for (var c in Yl)
            Yl.hasOwnProperty(c) && Yl[c](this, n[c], $l);
        C(this),
            n.finishInit && n.finishInit(this);
        for (var f = 0; f < Jl.length; ++f)
            Jl[f](this);
        wr(this),
            gl && n.lineWrapping && "optimizelegibility" == getComputedStyle(l.lineDiv).textRendering && (l.lineDiv.style.textRendering = "auto")
    }
    ...
    function t(e, t, r) {
        ...
        this.input = r,
            ...
            n.selectionDiv = Ro("div", null, null, "position: relative; z-index: 1"),
            ...
            n.lineSpace = Ro("div", [n.measure, n.lineMeasure, n.selectionDiv, n.cursorDiv, n.lineDiv], null, "position: relative; outline: none"),
            n.mover = Ro("div", [Ro("div", [n.lineSpace], "CodeMirror-lines")], null, "position: relative"),
            n.sizer = Ro("div", [n.mover], "CodeMirror-sizer"),
            n.sizerWidth = null,
            n.heightForcer = Ro("div", null, null, "position: absolute; height: " + Ms + "px; width: 1px;"),
            n.gutters = Ro("div", null, "CodeMirror-gutters"),
            n.lineGutter = null,
            n.scroller = Ro("div", [n.sizer, n.heightForcer, n.gutters], "CodeMirror-scroll"),
            n.scroller.setAttribute("tabIndex", "-1"),
            n.wrapper = Ro("div", [n.scrollbarFiller, n.gutterFiller, n.scroller], "CodeMirror"),
            dl && 8 > pl && (n.gutters.style.zIndex = -1,
    ...
    function i(e) {
        e.options.lineWrapping ? (Vs(e.display.wrapper, "CodeMirror-wrap"),
                e.display.sizer.style.minWidth = "",
                e.display.sizerWidth = null) : (Us(e.display.wrapper, "CodeMirror-wrap"),
                h(e)),
            l(e),
            Hr(e),
            or(e),
    ...
    function g(e, t, r) {
        ...
        e(n),
            ...
            dl && 8 > pl && (this.horiz.style.minHeight = this.vert.style.minWidth = "18px")
    }
    ...
    function m(t) {
        t.display.scrollbars && (t.display.scrollbars.clear(),
                t.display.scrollbars.addClass && Us(t.display.wrapper, t.display.scrollbars.addClass)),
            ...
            t.display.scrollbars.addClass && Vs(t.display.wrapper, t.display.scrollbars.addClass)
    }
    ...
    function w(e, t, r) {
        ...
        if (r && r.ensure) {
            var s = r.ensure.from.line,
                a = r.ensure.to.line;
            o > s ? (o = s,
                l = Qi(t, Ji(_i(t, s)) + e.wrapper.clientHeight)) : Math.min(a, t.lastLine()) >= l && (o = Qi(t, Ji(_i(t, a)) - e.wrapper.clientHeight),
                l = a)
        }
        return {
            from: o,
    ...
    function M(e, t) {
        ...
        if (t.editorIsHidden)
            return Pr(e), !1;
        if (!t.force && t.visible.from >= r.viewFrom && t.visible.to <= r.viewTo && (null == r.updateLineNumbers || r.updateLineNumbers >= r.viewTo) && r.renderedView == r.view && 0 == Rr(e))
            return !1;
        C(e) && (Pr(e),
            t.dims = H(e));
    ...
    function W(e, t) {
        ...
        e.display.heightForcer.style.top = r + "px",
            e.display.gutters.style.height = Math.max(r + Kt(e), t.clientHeight) + "px"
    }
    ...
    function I(e, t, r) {
        function n(t) {
            var r = t.nextSibling;
            return gl && Ll && e.display.currentWheelTarget == t ? t.style.display = "none" : t.parentNode.removeChild(t),
                r
        }
        for (var i = e.display, o = e.options.lineNumbers, l = i.lineDiv, s = l.firstChild, a = i.view, u = i.viewFrom, c = 0; c < a.length; c++) {
            ...
            ;
                ...
                f.changes && (Wo(f.changes, "gutter") > -1 && (h = !1),
                        P(e, f, u, r)),
                    h && (Bo(f.lineNumber),
    ...
    function E(e) {
        return e.node == e.text && (e.node = Ro("div", null, null, "position: relative"),
    ...
    function B(e) {
        z(e),
            e.line.wrapClass ? E(e).className = e.line.wrapClass : e.node != e.text && (e.node.className = "");
    ...
    function G(e, t, r, n) {
        ...
        if (e.options.lineNumbers || i) {
            ...
            if (e.display.input.setUneditable(l),
                ...
                t.line.gutterClass && (l.className += " " + t.line.gutterClass), !e.options.lineNumbers || i && i["CodeMirror-linenumbers"] || (t.lineNumber = l.appendChild(Ro("div", S(e.options, r), "CodeMirror-linenumber CodeMirror-gutter-elt", "left: " + n.gutterLeft["CodeMirror-linenumbers"] + "px; width: " + e.display.lineNumInnerWidth + "px"))),
                i)
            ...
            for (var r = e.doc.sel, n = r.ranges.length - 1; n >= 0; n--) {
                ...
                if (!(i.head.ch > 100 || n && r.ranges[n - 1].head.line == i.head.line)) {
                    ...
                    if (o.electricChars) {
                        ...
                        o.electricInput && o.electricInput.test(_i(e.doc, i.head.line).text.slice(0, i.head.ch)) && (l = En(e, i.head.line, "smart"));
    ...
    function nt() {
        ...
        return gl ? e.style.width = "1000px" : e.setAttribute("wrap", "off"),
    ...
    function ht(e, t) {
        ...
        for (var n = 1; n < e.length; n++) {
            ...
            if (Dl(o.to(), i.from()) >= 0) {
                ...
                t >= n && --t,
                    e.splice(--n, 2, new ft(a ? s : l, a ? l : s))
            }
        }
        return new ct(e, t)
    }
    ...
    function Lt(e, t) {
        ...
        return ks(e, "beforeSelectionChange", e, r),
    ...
    function Tt(e, t, r) {
        Mt(e, t, r),
            so(e, e.sel, e.cm ? e.cm.curOp.id : 0 / 0, r)
    }
            ...
            if (s.markedSpans)
                for (var a = 0; a < s.markedSpans.length; ++a) {
                    ...
                    if ((null == u.from || (c.inclusiveLeft ? u.from <= o.ch : u.from < o.ch)) && (null == u.to || (c.inclusiveRight ? u.to >= o.ch : u.to > o.ch))) {
                        ...
                        if (0 == Dl(f, o) && (f.ch += l,
                                f.ch < 0 ? f = f.line > e.first ? gt(e, Ol(f.line - 1)) : null : f.ch > s.text.length && (f = f.line < e.first + e.size - 1 ? Ol(f.line + 1, 0) : null), !f)) {
                            if (i)
                                return n ? (e.cantEdit = !0,
                                    Ol(e.first, 0)) : Ot(e, t, r, !0);
                            i = !0,
                                f = t,
                                l = -l
                        }
    ...
    function Pt(e, t, r) {
        function n(e, t, r, n) {
            0 > t && (t = 0),
                t = Math.round(t),
                n = Math.round(n),
                s.appendChild(Ro("div", null, "CodeMirror-selected", "position: absolute; left: " + e + "px; top: " + t + "px; width: " + (null == r ? c - e : r) + "px; height: " + (n - t) + "px"))
        }
        ...
        function i(t, r, i) {
            ...
            return Zo(eo(f), r || 0, null == i ? h : i, function(e, t, l) {
                ...
                null == r && 0 == e && (d = u),
                    f.top - g.top > 3 && (n(d, g.top, null, g.bottom),
                        d = u,
    ...
    function Bt(e, t, r) {
        ...
        return l = l ? ts(n.mode, l) : rs(n.mode),
            n.iter(o, t, function(r) {
                Di(e, r.text, l);
                var s = o == t - 1 || o % 5 == 0 || o >= i.viewFrom && o < i.viewTo;
                r.stateAfter = s ? ts(n.mode, l) : null,
                    ++o
            }),
            r && (n.frontier = o),
            l
    ...
    function $t(e, t) {
        ...
        return n.text = i.pre,
            Go(e.display.lineMeasure, i.pre),
            n
    }
    ...
    function Jt(e, t, r, n, i) {
        ...
        return t.cache.hasOwnProperty(l) ? o = t.cache[l] : (t.rect || (t.rect = t.view.text.getBoundingClientRect()),
            t.hasHeights || (_t(e, t.view, t.rect),
                t.hasHeights = !0),
            o = tr(e, t, r, n),
            o.bogus || (t.cache[l] = o)), {
            left: o.left,
    ...
    function tr(e, t, r, n) {
        ...
        if (3 == l.nodeType) {
            for (var c = 0; 4 > c; c++) {
                for (; s && Fo(t.line.text.charAt(o.coverStart + s));)
                    --s;
                for (; o.coverStart + a < o.coverEnd && Fo(t.line.text.charAt(o.coverStart + a));)
                    ++a;
                if (dl && 9 > pl && 0 == s && a == o.coverEnd - o.coverStart)
                    ...
                    i = Ps(l, s, a).getBoundingClientRect() || zl;
    ...
    function rr(e, t) {
        if (!window.screen || null == screen.logicalXDPI || screen.logicalXDPI == screen.deviceXDPI || !qo(e))
            return t;
    ...
    function cr(e, t, r, n, i) {
        return n || (n = _i(e.doc, t.line)),
            ar(e, n, qt(e, n, t.ch, i), r)
    }
    ...
    function fr(e, t, r, n, i, o) {
        ...
        function s(e, t) {
            var r = a[t],
                n = r.level % 2;
            return e == Qo(r) && t && r.level < a[t - 1].level ? (r = a[--t],
                    e = Jo(r) - (r.level % 2 ? 0 : 1),
                    n = !0) : e == Jo(r) && t < a.length - 1 && r.level < a[t + 1].level && (r = a[++t],
                    e = Qo(r) - r.level % 2,
                    n = !1),
    ...
    function pr(e, t, r) {
        ...
        if (r += e.display.viewOffset,
            0 > r)
            return dr(n.first, 0, !0, -1);
        var i = Qi(n, r),
            o = n.first + n.size - 1;
        if (i > o)
            return dr(n.first + n.size - 1, _i(n, o).text.length, !0, 1);
        0 > t && (t = 0);
        for (var l = _i(n, i);;) {
            var s = gr(e, l, i, t, r),
                a = hi(l),
    ...
    function gr(e, t, r, n, i) {
        ...
        for (;;) {
            if (c ? d == h || d == al(t, h, 1) : 1 >= d - h) {
                for (var y = p > n || v - n >= n - p ? h : d, b = n - (y == h ? p : v); Fo(t.text.charAt(y));)
                    ++y;
    ...
    function Lr(e) {
        ...
        e.updatedDisplay && O(t),
            e.barMeasure = p(t),
            r.maxLineChanged && !t.options.lineWrapping && (e.adjustWidthTo = qt(t, r.maxLine, r.maxLine.text.length).left + 3,
                t.display.sizerWidth = e.adjustWidthTo,
                e.barMeasure.scrollWidth = Math.max(r.scroller.clientWidth, r.sizer.offsetLeft + e.adjustWidthTo + Kt(t) + t.display.barWidth),
                e.maxScrollLeft = Math.max(0, r.sizer.offsetLeft + e.adjustWidthTo - jt(t))),
    ...
    function Tr(e) {
        var t = e.cm,
            r = t.display,
            n = t.doc;
        if (e.updatedDisplay && A(t, e.update),
            ...
            null == e.scrollLeft || r.scroller.scrollLeft == e.scrollLeft && !e.forceScroll || (n.scrollLeft = Math.max(0, Math.min(r.scroller.scrollWidth - jt(t), e.scrollLeft)),
    ...
    function Hr(e, t, r, n) {
        ...
        if (n && r < i.viewTo && (null == i.updateLineNumbers || i.updateLineNumbers > t) && (i.updateLineNumbers = t),
            ...
            Wl && mi(e.doc, r + n) > i.viewFrom ? Pr(e) : (i.viewFrom += n,
                i.viewTo += n);
            ...
            o ? (i.view = i.view.slice(0, o.index),
                i.viewTo = o.lineN) : Pr(e)
        } else {
            var l = zr(e, t, t, -1),
                s = zr(e, r, r + n, 1);
            l && s ? (i.view = i.view.slice(0, l.index).concat(Dr(e, l.lineN, s.lineN)).concat(i.view.slice(s.index)),
                i.viewTo += n) : Pr(e)
        }
    ...
    function zr(e, t, r, n) {
        var i, o = Er(e, t),
            l = e.display.view;
        if (!Wl || r == e.doc.first + e.doc.size)
            return {
                index: o,
                lineN: r
            };
    ...
    function Fr(e, t, r) {
        var n = e.display,
            i = n.view;
        0 == i.length || t >= n.viewTo || r <= n.viewFrom ? (n.view = Dr(e, t, r),
                n.viewFrom = t) : (n.viewFrom > t ? n.view = Dr(e, t, n.viewFrom).concat(n.view) : n.viewFrom < t && (n.view = n.view.slice(Er(e, t))),
                n.viewFrom = t,
                n.viewTo < r ? n.view = n.view.concat(Dr(e, n.viewTo, r)) : n.viewTo > r && (n.view = n.view.slice(0, Er(e, r)))),
            n.viewTo = r
    }
    ...
    function Br(e) {
        ...
        Ss(i.scroller, "mousedown", Ar(e, jr)),
            dl && 11 > pl ? Ss(i.scroller, "dblclick", Ar(e, function(t) {
                if (!Co(e, t)) {
                    var r = Kr(e, t);
        ...
        Ss(i.scroller, "touchstart", function(e) {
            ...
            Ss(i.scroller, "touchend", function(r) {
                ...
                if (o && !Vr(i, r) && null != o.left && !o.moved && new Date - o.start < 300) {
                    ...
                    l = !o.prev || n(o, o.prev) ? new ft(s, s) : !o.prev.prev || n(o, o.prev.prev) ? e.findWordAt(s) : new ft(Ol(s.line, 0), gt(e.doc, Ol(s.line + 1, 0))),
            ...
            Ss(i.scroller, "scroll", function() {
                i.scroller.clientHeight && (Jr(e, i.scroller.scrollTop),
    ...
    function Kr(e, t, r, n) {
        var i = e.display;
        if (!r && "true" == yo(t).getAttribute("cm-not-content"))
            return null;
    ...
    function jr(e) {
        ...
        if (!(r.activeTouch && r.input.supportsTouch() || Co(t, e))) {
            if (r.shift = e.shiftKey,
                Vr(r, e))
                return void(gl || (r.scroller.draggable = !1,
                    setTimeout(function() {
    ...
    function Xr(e, t, r) {
        ...
        var n, i = +new Date;
        El && El.time > i - 400 && 0 == Dl(El.pos, r) ? n = "triple" : Pl && Pl.time > i - 400 && 0 == Dl(Pl.pos, r) ? (n = "double",
            El = {
                time: i,
                pos: r
            }) : (n = "single",
        ...
        var i = e.display,
            ...
            l = Ar(e, function(s) {
                gl && (i.scroller.draggable = !1),
                    ...
                    Math.abs(t.clientX - s.clientX) + Math.abs(t.clientY - s.clientY) < 10 && (ws(s), !n && +new Date - 200 < o && wt(e.doc, r),
                        gl || dl && 9 == pl ? setTimeout(function() {
                            document.body.focus(),
                                i.input.focus()
                        }, 20) : i.input.focus())
            });
    ...
    function Yr(e, t, r, n, i) {
                ...
                if (v = t,
                    ...
                    if ("single" != n) {
                        if ("double" == n)
                            ...
                            var C = new ft(Ol(t.line, 0), gt(u, Ol(t.line + 1, 0)));
                        Dl(C.anchor, w) > 0 ? (x = C.head,
                            w = $(b.from(), C.anchor)) : (x = C.anchor,
                            w = Y(b.to(), C.head))
                    }
        ...
        var c, f, h = u.sel,
            d = h.ranges;
        if (i && !t.shiftKey ? (f = u.sel.contains(r),
                c = f > -1 ? d[f] : new ft(r, r)) : (c = u.sel.primary(),
                f = u.sel.primIndex),
            t.altKey)
            n = "rect",
            i || (c = new ft(r, r)),
            ...
            c = bt(u, c, r);
        i ? -1 == f ? (f = d.length,
            Tt(u, ht(d.concat([c]), f), {
                scroll: !1,
                origin: "*mouse"
            })) : d.length > 1 && d[f].empty() && "single" == n && !t.shiftKey ? (Tt(u, ht(d.slice(0, f).concat(d.slice(f + 1)), 0)),
            h = u.sel) : Ct(u, f, c, Ws) : (f = 0,
            Tt(u, new ct([c], 0), Ws),
            h = u.sel);
        var v = r,
    ...
    function Qr(e, t) {
        if (dl && (!e.state.draggingText || +new Date - Bl < 100))
            return void Cs(t);
        if (!Co(e, t) && !Vr(e.display, t) && (t.dataTransfer.setData("Text", e.getSelection()),
    ...
    function tn(e, t) {
        ...
        if (n && l.scrollWidth > l.clientWidth || i && l.scrollHeight > l.clientHeight) {
            ...
            if (n && !cl && !yl && null != Ul)
                return i && Jr(e, Math.max(0, Math.min(l.scrollTop + i * Ul, l.scrollHeight - l.clientHeight))),
                    en(e, Math.max(0, Math.min(l.scrollLeft + n * Ul, l.scrollWidth - l.clientWidth))),
                    ws(t),
            ...
            if (i && null != Ul) {
                ...
                0 > c ? f = Math.max(0, f + c - 50) : h = Math.min(e.doc.height, h + c + 50),
                    N(e, {
                        top: f,
                        bottom: h
                    })
            }
            20 > Gl && (null == o.wheelStartX ? (o.wheelStartX = l.scrollLeft,
    ...
    function an(e) {
        ...
        if (t.curOp.focus = Uo(), !Co(t, e)) {
            ...
            var n = ln(t, e);
            yl && (jl = n ? r : null, !n && 88 == r && !Ys && (Ll ? e.metaKey : e.ctrlKey) && t.replaceSelection("", null, "cut")),
                18 != r || /\bCodeMirror-crosshair\b/.test(t.display.lineDiv.className) || un(t)
        }
    }

    function un(e) {
        function t(e) {
            18 != e.keyCode && e.altKey || (Us(r, "CodeMirror-crosshair"),
                Ls(document, "keyup", t),
    ...
    function dn(e) {
        e.state.delayingBlurEvent && (e.state.delayingBlurEvent = !1),
            "nocursor" != e.options.readOnly && (e.state.focused || (ks(e, "focus", e),
                    e.state.focused = !0,
    ...
    function pn(e) {
        e.state.delayingBlurEvent || (e.state.focused && (ks(e, "blur", e),
                e.state.focused = !1,
    ...
    function mn(e, t) {
        ...
        var r = e.line + t.text.length - (t.to.line - t.from.line) - 1,
            n = e.ch;
        return e.line == t.to.line && (n += Xl(t).ch - t.to.ch),
            Ol(r, n)
    }
    ...
    function Sn(e, t) {
        if (1 != t.text.length || "" != t.text[0] || 0 != Dl(t.from, t.to)) {
            var r = yn(e, t);
            oo(e, t, r, e.cm ? e.cm.curOp.id : 0 / 0),
                Tn(e, t, r, ti(e, t));
            var n = [];
            ji(e, function(e, r) {
                r || -1 != Wo(n, e.history) || (vo(e.history, t),
                        n.push(e.history)),
                    Tn(e, t, null, ti(e, t))
            })
        }
        ...
        if (!e.cm || !e.cm.state.suppressEdits) {
            ...
            if (a != l.length) {
                ...
                for (var c = Lo(e, "beforeChange") || e.cm && Lo(e.cm, "beforeChange"), a = n.changes.length - 1; a >= 0; --a) {
                    ...
                    var d = [];
                    ji(e, function(e, t) {
                        t || -1 != Wo(d, e.history) || (vo(e.history, f),
                                d.push(e.history)),
                            Tn(e, f, null, ni(e, f))
                    })
                }
    ...
    function kn(e, t) {
        if (0 != t && (e.first += t,
                e.sel = new ct(Oo(e.sel.ranges, function(e) {
    ...
    function Mn(e, t, r) {
        var n = e.doc,
            ...
            a = !1,
            u = l.line;
        e.options.lineWrapping || (u = Zi(pi(_i(n, l.line))),
    ...
    function Wn(e, t, r, n) {
        ...
        for (var i = 0; 5 > i; i++) {
            var o = !1,
                ...
                u = e.doc.scrollTop,
                c = e.doc.scrollLeft;
            if (null != a.scrollTop && (Jr(e, a.scrollTop),
                    Math.abs(e.doc.scrollTop - u) > 1 && (o = !0)),
                null != a.scrollLeft && (en(e, a.scrollLeft),
                    Math.abs(e.doc.scrollLeft - c) > 1 && (o = !0)), !o)
                break
        }
        return l
    }
    ...
    function In(e) {
        ...
        var t = e.getCursor(),
            r = t,
            n = t;
        e.options.lineWrapping || (r = t.ch ? Ol(t.line, t.ch - 1) : t,
                n = Ol(t.line, t.ch + 1)),
            e.curOp.scrollToPos = {
                from: r,
                to: n,
    ...
    function En(e, t, r, n) {
        ...
        if (n || /\S/.test(s.text)) {
            ...
            u = 0,
            r = "not";
        "prev" == r ? u = t > o.first ? Ds(_i(o, t - 1).text, null, l) : 0 : "add" == r ? u = a + e.options.indentUnit : "subtract" == r ? u = a - e.options.indentUnit : "number" == typeof r && (u = a + r),
            u = Math.max(0, u);
        var f = "",
            h = 0;
        ...
        if (u > h && (f += Ao(u - h)),
            f != c)
            return An(o, f, Ol(t, 0), Ol(t, c.length), "+input"),
                s.stateAfter = null, !0;
    ...
    function zn(e, t, r, n) {
        var i = t,
            o = t;
        return "number" == typeof t ? o = _i(e, pt(e, t)) : i = Zi(t),
            null == i ? null : (n(o, i) && e.cm && Ir(e.cm, i, r),
                o)
    }
    ...
    function Kn(e, t, r, n, i) {
        ...
        if (o.replacedWith && (o.collapsed = !0,
            ...
            o.collapsed) {
            if (di(e, t.line, t, r, o) || t.line != r.line && di(e, r.line, t, r, o))
        ...
        if (e.iter(a, r.line + 1, function(e) {
                u && o.collapsed && !u.options.lineWrapping && pi(e) == u.display.maxLine && (s = !0),
                    o.collapsed && a != t.line && qi(e, 0),
                    Qn(e, new $n(o, a == t.line ? t.ch : null, a == r.line ? r.ch : null)),
                    ++a
            }),
    ...
    function ti(e, t) {
        ...
        if (!u) {
            ...
            if (v > 0 && s)
                for (var f = 0; f < s.length; ++f)
                    null == s[f].to && (g || (g = [])).push(new $n(s[f].marker, null, null));
            for (var f = 0; v > f; ++f)
                p.push(g);
            p.push(a)
        }
    ...
    function ci(e, t) {
        ...
        if (n)
            for (var i, o = 0; o < n.length; ++o)
                i = n[o],
                i.marker.collapsed && null == (t ? i.from : i.to) && (!r || ui(r, i.marker) < 0) && (r = i.marker);
        return r
    }
        ...
        if (l)
            for (var s = 0; s < l.length; ++s) {
                ...
                if (a.marker.collapsed) {
                    ...
                    if (!(c >= 0 && 0 >= f || 0 >= c && f >= 0) && (0 >= c && (Dl(u.to, r) > 0 || a.marker.inclusiveRight && i.inclusiveLeft) || c >= 0 && (Dl(u.from, n) < 0 || a.marker.inclusiveLeft && i.inclusiveRight)))
                        return !0
                }
            }
    }
        ...
        if (r)
            for (var n, i = 0; i < r.length; ++i)
                if (n = r[i],
                    ...
                    if (null == n.from)
                        return !0;
                    if (!n.marker.widgetNode && 0 == n.from && n.marker.inclusiveLeft && bi(e, t, n))
                        return !0
                }
    }
    ...
    function bi(e, t, r) {
        ...
        for (var i, o = 0; o < t.markedSpans.length; ++o)
            if (i = t.markedSpans[o],
                i.marker.collapsed && !i.marker.widgetNode && i.from == r.to && (null == i.to || i.to != r.from) && (i.marker.inclusiveLeft || r.marker.inclusiveRight) && bi(e, t, i))
                return !0
    }
    ...
    function Oi(e, t, r) {
        if (!t.styles || t.styles[0] != e.state.modeGen) {
            ...
            t.styles = n.styles,
                n.classes ? t.styleClasses = n.classes : t.styleClasses && (t.styleClasses = null),
    ...
    function Di(e, t, r, n) {
        ...
        for (o.start = o.pos = n || 0,
            "" == t && Ti(i, r); !o.eol() && o.pos <= e.options.maxHighlightLength;)
            Mi(i, o, r),
            o.start = o.pos
    }
    ...
    function Ii(e, t) {
        ...
        for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
            ...
            n.pos = 0,
                n.addToken = Ei,
                $o(e.display.measure) && (o = eo(l)) && (n.addToken = Fi(n.addToken, o)),
                n.map = [];
            var s = t != e.display.externalMeasured && Zi(l);
            Bi(l, n, Oi(e, l, s)),
                l.styleClasses && (l.styleClasses.bgClass && (n.bgClass = Ko(l.styleClasses.bgClass, n.bgClass || "")),
                    l.styleClasses.textClass && (n.textClass = Ko(l.styleClasses.textClass, n.textClass || ""))),
                0 == n.map.length && n.map.push(0, 0, n.content.appendChild(Yo(e.display.measure))),
                0 == i ? (t.measure.map = n.map,
                    t.measure.cache = {}) : ((t.measure.maps || (t.measure.maps = [])).push(n.map),
                    (t.measure.caches || (t.measure.caches = [])).push({}))
        }
        return gl && /\bcm-tab\b/.test(n.content.lastChild.className) && (n.content.className = "cm-tab-wrap-hack"),
                ...
                if (m == p) {
                    ...
                    for (var y = [], b = 0; b < n.length; ++b) {
                        ...
                        "bookmark" == x.type && w.from == p && x.widgetNode ? y.push(x) : w.from <= p && (null == w.to || w.to > p || x.collapsed && w.to == p && w.from == p) ? (null != w.to && w.to != p && m > w.to && (m = w.to,
                            ...
                            x.title && !f && (f = x.title),
                            x.collapsed && (!h || ui(h.marker, x) < 0) && (h = w)) : w.from > p && m > w.from && (m = w.from)
                    }
                    if (h && (h.from || 0) == p) {
                        if (Ri(t, (null == h.to ? d + 1 : h.to) - p, h.marker, null == h.from),
                            null == h.to)
                            return;
                        h.to == p && (h = !1)
                    }
    ...
    function Zi(e) {
        if (null == e.parent)
            return null;
        for (var t = e.parent, r = Wo(t.lines, e), n = t.parent; n; t = n,
            n = n.parent)
    ...
    function eo(e) {
        var t = e.order;
        return null == t && (t = e.order = Qs(e.text)),
            t
    }
    ...
    function ro(e, t) {
        ...
        return uo(e, r, t.from.line, t.to.line + 1),
            ji(e, function(e) {
    ...
    function io(e, t) {
        return t ? (no(e.done),
            No(e.done)) : e.done.length && !No(e.done).ranges ? No(e.done) : e.done.length > 1 && !e.done[e.done.length - 2].ranges ? (e.done.pop(),
            No(e.done)) : void 0
    }
    ...
    function oo(e, t, r, n) {
        ...
        if ((i.lastOp == n || i.lastOrigin == t.origin && t.origin && ("+" == t.origin.charAt(0) && e.cm && i.lastModTime > l - e.cm.options.historyEventDelay || "*" == t.origin.charAt(0))) && (o = io(i, i.lastOp == n))) {
            ...
            var a = No(i.done);
            for (a && a.ranges || ao(e.sel, i.done),
                o = {
                    changes: [ro(e, t)],
                    generation: i.generation
                },
    ...
    function so(e, t, r, n) {
        var i = e.history,
            o = n && n.origin;
        r == i.lastSelOp || o && i.lastSelOrigin == o && (i.lastModTime == i.lastSelTime && i.lastOrigin == o || lo(e, o, No(i.done), t)) ? i.done[i.done.length - 1] = t : ao(t, i.done),
    ...
    function ho(e, t, r) {
        for (var n = 0, i = []; n < e.length; ++n) {
            var o = e[n];
            if (o.ranges)
                i.push(r ? ct.prototype.deepCopy.call(o) : o);
            else {
                var l = o.changes,
                    s = [];
                i.push({
                ...
                for (var a = 0; a < l.length; ++a) {
                    ...
                    if (s.push({
                        ...
                        t)
                        for (var f in c)
                            (u = f.match(/^spans_(\d+)$/)) && Wo(t, Number(u[1])) > -1 && (No(s)[f] = c[f],
                                delete c[f])
                }
            }
        }
        ...
        for (var i = 0; i < e.length; ++i) {
            ...
            if (o.ranges) {
                ...
                for (var s = 0; s < o.ranges.length; s++)
                    po(o.ranges[s].anchor, t, r, n),
                    po(o.ranges[s].head, t, r, n)
            } else {
    ...
    function wo(e, t) {
        ...
        if (n) {
            ...
            Fl ? i = Fl.delayedCallbacks : Ts ? i = Ts : (i = Ts = [],
                setTimeout(xo, 0));
    ...
    function Ho(e, t) {
        var r;
        return Object.create ? r = Object.create(e) : (Do.prototype = e,
                r = new Do),
            t && Io(t, r),
            r
    }
    ...
    function Yo(e) {
        if (null == Bs) {
            ...
            Go(e, Ro("span", [t, document.createTextNode("x")])),
                0 != e.firstChild.offsetHeight && (Bs = t.offsetWidth <= 1 && t.offsetHeight > 2 && !(dl && 8 > pl))
        }
    ...
    function ll(e, t) {
        ...
        for (var r, n = 0; n < e.length; ++n) {
            ...
            if (i.from == t || i.to == t) {
                if (null != r)
                    return ol(e, i.level, e[r].level) ? (i.from != i.to && (Zs = r),
                        n) : (i.from != i.to && (Zs = n),
                        r);
                r = n
            }
    ...
    g.prototype = Io({
            ...
            overlayHack: function() {
                ...
                Ss(this.vert, "mousedown", r),
                    Ss(this.horiz, "mousedown", r)
            },
            clear: function() {
    ...
    var Ol = e.Pos = function(e, t) {
            return this instanceof Ol ? (this.line = e,
                void(this.ch = t)) : new Ol(e, t)
        },
    ...
    rt.prototype = Io({
            init: function(e) {
                function t(e) {
                    if (n.somethingSelected())
                        ...
                        var t = et(n);
                        Hl = t.text,
                            "cut" == e.type ? n.setSelections(t.ranges, null, Ns) : (r.prevInput = "",
                                o.value = t.text.join("\n"),
                                Is(o))
                    }
                ...
                e.wrapper.insertBefore(i, e.wrapper.firstChild),
                    ...
                    Ss(e.scroller, "paste", function(t) {
                        Vr(e, t) || (n.state.pasteIncoming = !0,
                            r.focus())
                    }),
            ...
            focus: function() {
                if ("nocursor" != this.cm.options.readOnly && (!Sl || Uo() != this.textarea))
                    try {
                        this.textarea.focus()
                    } catch (e) {}
            },
            ...
            poll: function() {
                var e = this.cm,
                    t = this.textarea,
                    r = this.prevInput;
                if (!e.state.focused || _s(t) && !r || Z(e) || e.options.disableInput || e.state.keySeq)
                    return !1;
                ...
                if (n == r && !e.somethingSelected())
                    return !1;
                if (dl && pl >= 9 && this.hasSelection === n || Ll && /[\uf700-\uf7ff]/.test(n))
                ...
                return Mr(e, function() {
                    Q(e, n.slice(o), r.length - o, null, s.composing ? "*compose" : null),
            ...
            onContextMenu: function(e) {
                ...
                function r() {
                    if (n.contextMenuPending = !1,
                        ...
                        l.style.cssText = c,
                        dl && 9 > pl && o.scrollbars.setScrollTop(o.scroller.scrollTop = a),
                ...
                if (s && !yl) {
                    ...
                    if (n.wrapper.style.position = "absolute",
                        l.style.cssText = "position: fixed; width: 30px; height: 30px; top: " + (e.clientY - 5) + "px; left: " + (e.clientX - 5) + "px; z-index: 1000; background: " + (dl ? "rgba(255, 255, 255, .05)" : "transparent") + "; outline: none; border-width: 0; outline: none; overflow: hidden; opacity: .05; filter: alpha(opacity=5);",
                        gl)
        ...
        it.prototype = Io({
            init: function(e) {
                function t(e) {
                    ...
                    if (e.clipboardData && !Cl)
                        ...
                        var r = nt(),
                            i = r.firstChild;
                        n.display.lineSpace.insertBefore(r, n.display.lineSpace.firstChild),
                            i.value = Hl.join("\n");
                        var o = document.activeElement;
                        Is(i),
                            setTimeout(function() {
                                n.display.lineSpace.removeChild(r),
                                    o.focus()
                            }, 50)
                    }
                }
                ...
                i.contentEditable = "true",
                    ...
                    Ss(i, "paste", function(e) {
                        ...
                        t && (e.preventDefault(),
                            n.replaceSelection(t, null, "paste"))
                    }),
            ...
            showPrimarySelection: function() {
                ...
                if (!r || r.bad || !n || n.bad || 0 != Dl($(r, n), t.from()) || 0 != Dl(Y(r, n), t.to())) {
                    ...
                    if (i || o) {
                        ...
                        c && (e.removeAllRanges(),
                                e.addRange(c),
                                s && null == e.anchorNode ? e.addRange(s) : cl && this.startGracePeriod()),
            ...
            pollContent: function() {
                ...
                for (var d = 0, p = 0, g = f[0], v = h[0], m = Math.min(g.length, v.length); m > d && g.charCodeAt(d) == v.charCodeAt(d);)
                    ++d;
                for (var y = No(f), b = No(h), w = Math.min(y.length - (1 == f.length ? d : 0), b.length - (1 == h.length ? d : 0)); w > p && y.charCodeAt(y.length - p - 1) == b.charCodeAt(b.length - p - 1);)
                    ++p;
            ...
            onKeyPress: function(e) {
                e.preventDefault(),
                    Ar(this.cm, Q)(this.cm, String.fromCharCode(null == e.charCode ? e.keyCode : e.charCode), 0)
            },
            onContextMenu: Do,
            resetPosition: Do,
        ...
        ct.prototype = {
            ...
            equals: function(e) {
                ...
                for (var t = 0; t < this.ranges.length; t++) {
                    var r = this.ranges[t],
                        n = e.ranges[t];
                    if (0 != Dl(r.anchor, n.anchor) || 0 != Dl(r.head, n.head))
                        return !1
                }
                return !0
            },
    ...
    e.prototype = {
            ...
            setOption: function(e, t) {
                var r = this.options,
                    n = r[e];
                (r[e] != t || "mode" == e) && (r[e] = t,
                    Yl.hasOwnProperty(e) && Ar(this, Yl[e])(this, t, n))
            },
            ...
            indentSelection: Nr(function(e) {
                for (var t = this.doc.sel.ranges, r = -1, n = 0; n < t.length; n++) {
                    var i = t[n];
                    if (i.empty())
                        i.head.line > r && (En(this, i.head.line, e, !0),
                            r = i.head.line,
            ...
            getStateAfter: function(e, t) {
                var r = this.doc;
                return e = pt(r, null == e ? r.first + r.size - 1 : e),
                    Bt(this, e + 1, t)
            },
            cursorCoords: function(e, t) {
                var r, n = this.doc.sel.primary();
                return r = null == e ? n.head : "object" == typeof e ? gt(this.doc, e) : e ? n.from() : n.to(),
                    fr(this, r, t || "page")
            },
            ...
            coordsChar: function(e, t) {
                return e = ur(this, e, t || "page"),
                    pr(this, e.left, e.top)
            },
            ...
            moveV: Nr(function(e, t) {
                ...
                if (n.extendSelectionsBy(function(l) {
                        ...
                        null != l.goalColumn && (s.left = l.goalColumn),
                            i.push(s.left);
                        var a = Bn(r, s, e, t);
                        return "page" == t && l == n.sel.primary() && Hn(r, null, cr(r, a, "div").top - s.top),
                            a
                    }, Os),
                    i.length)
            ...
            toggleOverwrite: function(e) {
                (null == e || e != this.state.overwrite) && ((this.state.overwrite = !this.state.overwrite) ? Vs(this.display.cursorDiv, "CodeMirror-overwrite") : Us(this.display.cursorDiv, "CodeMirror-overwrite"),
            ...
            refresh: Nr(function() {
                ...
                Hr(this),
                    ...
                    c(this),
                    (null == e || Math.abs(e - vr(this.display)) > .5) && l(this),
    ...
    Gn("value", "", function(e, t) {
        ...
        Gn("specialChars", /[\t\u0000-\u0019\u00ad\u200b-\u200f\u2028\u2029\ufeff]/g, function(t, r, n) {
        ...
        Gn("electricChars", !0),
        Gn("inputStyle", Sl ? "contenteditable" : "textarea", function() {
    ...
    e.defineMode = function(t, r) {
        ...
        e.resolveMode = function(t) {
            if ("string" == typeof t && Zl.hasOwnProperty(t))
                t = Zl[t];
            ...
            transposeChars: function(e) {
                Mr(e, function() {
                    for (var t = e.listSelections(), r = [], n = 0; n < t.length; n++) {
                        ...
                        if (o)
                            if (i.ch == o.length && (i = new Ol(i.line, i.ch - 1)),
                                i.ch > 0)
                                i = new Ol(i.line, i.ch + 1),
                                e.replaceRange(o.charAt(i.ch - 1) + o.charAt(i.ch - 2), Ol(i.line, i.ch - 2), i, "+transpose");
    ...
    var os = e.lookupKey = function(e, t, r, n) {
        ...
        ss = e.keyName = function(e, t) {
            if (yl && 34 == e.keyCode && e["char"])
                return !1;
            var r = qs[e.keyCode],
                n = r;
            return null == n || e.altGraphKey ? !1 : (e.altKey && "Alt" != r && (n = "Alt-" + n),
                (Ml ? e.metaKey : e.ctrlKey) && "Ctrl" != r && (n = "Ctrl-" + n),
                (Ml ? e.ctrlKey : e.metaKey) && "Cmd" != r && (n = "Cmd-" + n), !t && e.shiftKey && "Shift" != r && (n = "Shift-" + n),
                n)
        };
    e.fromTextArea = function(t, r) {
        ...
        if (r = r ? Io(r) : {},
            r.value = t.value, !r.tabindex && t.tabIndex && (r.tabindex = t.tabIndex), !r.placeholder && t.placeholder && (r.placeholder = t.placeholder),
            null == r.autofocus) {
            var i = Uo();
    ...
    as.prototype = {
        ...
        column: function() {
            return this.lastColumnPos < this.start && (this.lastColumnValue = Ds(this.string, this.start, this.tabSize, this.lastColumnPos, this.lastColumnValue),
                    this.lastColumnPos = this.start),
                this.lastColumnValue - (this.lineStart ? Ds(this.string, this.lineStart, this.tabSize) : 0)
        },
        ...
        cs.prototype.clear = function() {
            if (!this.explicitlyCleared) {
                ...
                for (var n = null, i = null, o = 0; o < this.lines.length; ++o) {
                    ...
                    e && !this.collapsed ? Ir(e, Zi(l), "text") : e && (null != s.to && (i = Zi(l)),
                            null != s.from && (n = Zi(l))),
                        l.markedSpans = Zn(l.markedSpans, s),
                        null == s.from && this.collapsed && !yi(this.doc, l) && e && qi(l, vr(e.display))
                }
        ...
        cs.prototype.find = function(e, t) {
            ...
            for (var r, n, i = 0; i < this.lines.length; ++i) {
                ...
                if (null != l.from && (r = Ol(t ? o : Zi(o), l.from), -1 == e))
                    return r;
                if (null != l.to && (n = Ol(t ? o : Zi(o), l.to),
                        1 == e))
                    return n
            }
            return r && {
        ...
        cs.prototype.changed = function() {
            ...
            e && r && Mr(r, function() {
                ...
                if (o && (nr(o),
                    ...
                    r.curOp.updateMaxLine = !0, !yi(t.doc, n) && null != t.height) {
                    var l = t.height;
                    t.height = null;
                    var s = xi(t) - l;
                    s && qi(n, n.height + s)
    ...
    ms.prototype = Ho(Ki.prototype, {
            ...
            getLineHandleVisualStart: function(e) {
                return "number" == typeof e && (e = _i(this, e)),
                    pi(e)
            },
            lineCount: function() {
                return this.size
            ...
            replaceSelections: Wr(function(e, t, r) {
                ...
                for (var s = t && "end" != t && wn(this, n, t), o = n.length - 1; o >= 0; o--)
                    Cn(this, n[o]);
    ...
    for (var bs in ms.prototype)
        ms.prototype.hasOwnProperty(bs) && Wo(ys, bs) < 0 && (e.prototype[bs] = function(e) {
            return function() {
    ...
    e.keyNames = qs,
        function() {
            for (var e = 0; 10 > e; e++)
                qs[e + 48] = qs[e + 96] = String(e);
            for (var e = 65; 90 >= e; e++)
                qs[e] = String.fromCharCode(e);
            for (var e = 1; 12 >= e; e++)
                qs[e + 111] = qs[e + 63235] = "F" + e
        }();
    var Zs, Qs = function() {
        function e(e) {
        ...
        return function(r) {
            ...
            for (var h = 0, p = u; c > h; ++h) {
                var n = f[h];
                "1" == n && "r" == p ? f[h] = "n" : l.test(n) && (p = n,
                    "r" == n && (f[h] = "R"))
            }
            for (var h = 1, d = f[0]; c - 1 > h; ++h) {
                var n = f[h];
                "+" == n && "1" == d && "1" == f[h + 1] ? f[h] = "1" : "," != n || d != f[h + 1] || "1" != d && "n" != d || (f[h] = d),
                    d = n
            }
            for (var h = 0; c > h; ++h) {
                var n = f[h];
