...
! function(e) {
    ...
    o.modules = {},
        ...
        t.fn.define = function(e, t) {
            ...
            return i && (t = e,
                    e = []),
                layui["layui.all"] ? r.call(n) : (n.use(e, r),
                    n)
        },
        t.fn.use = function(e, t, a) {
            function s(e, t) {
                var n = "PLaySTATION 3" === navigator.platform ? /^complete$/ : /^(complete|loaded)$/;
                ("load" === e.type || n.test((e.currentTarget || e.srcElement).readyState)) && (o.modules[y] = t,
                    m.removeChild(p),
                    function i() {
            ...
            e = "string" == typeof e ? [e] : e,
                window.jQuery && jQuery.fn.on && (d.each(e, function(t, n) {
            ...
            var y = e[0],
                v = 0;
            if (a = a || [],
                o.host = o.host || (f.match(/\/\/([\s\S]+?)\//) || ["//" + location.host + "/"])[0],
                0 === e.length)
                return t();
