...
theurl = 'http://blog.163.com/mjt1220@126/album/'
...
class Wangyi:
    ...
    def get_xiangceSet_page_urls(self):
        ...
        # divSet = bsObj.findAll("div", {"class": "pitm clearfix fc03 tag"})
        # divSet01 = divSet[0].a["href"]
        print(bsObj)
        # print(divSet01)
...
if __name__ == '__main__':
    url = "http://blog.163.com/mjt1220@126/album/#m=0&p=1"

    s = Wangyi(url)
    s.get_xiangceSet_page_urls()
