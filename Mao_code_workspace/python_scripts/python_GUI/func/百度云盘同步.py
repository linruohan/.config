'''
@Author: your name
@Date: 2019-12-14 10:19:02
@LastEditTime: 2019-12-14 10:32:40
@LastEditors: Please set LastEditors
@Description: In User Settings Edit
@FilePath: \python_GUI\tongbu.py
'''
#  -*- coding: utf-8 -*-
...
class BypyBackup:
    ...
    def no_zip_tongbu(self, path, remote_path):
        ...
        if self.bp.list(path):
            ...
            # 云端存在 syncup
            # print("cunzai")
            self.bp.syncup(localdir=(path), remotedir=remote_path)
...
if __name__ == "__main__":
    paths = [
        # r"C:\Users\xiaohan",  # 桌面
        r"E:\workspace",  # 代码工作区
        # r"E:\娱乐\读书ireader",  # 小说阅读
        # r"E:\娱乐\lofter",  # lofter图片
        "E:\\图片",
        "E:\\Study",
        "F:\\Typora_book"
    ]
