...
class UI_base(QWidget):
    ...
    """
    def __init__(self):
        super(UI_base, self).__init__(None,
                                      Qt.FramelessWindowHint)  # 设置为顶级窗口，无边框
    ...
    def initLayout(self):
        ...
        self.main_layout.addWidget(QPushButton('1'), 1, 0, 1, 1)
        self.main_layout.addWidget(QPushButton('1'), 1, 1, 1, 1)
        self.main_layout.addWidget(QPushButton('2'), 2, 1, 1, 1)
        self.main_layout.addWidget(QPushButton('2'), 4, 1, 1, 1)
        self.main_layout.addWidget(QPushButton('2'), 5, 1, 1, 1)
        self.main_layout.addWidget(QPushButton('2'), 6, 1, 1, 1)
        self.setLayout(self.main_layout)

    def addLayout(self, QLayout, x, y, w, h):
        # 给widget定义一个addLayout函数，以实现往竖放框架的正确内容区内嵌套Layout框架
        self.main_layout.addLayout(QLayout, x, y, w, h)
