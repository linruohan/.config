...
class MainUi(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.main_layout.setSpacing(0)  # 因为可以发现图形界面中左侧部件和右侧部件中有一条缝隙，我们通过设置布局内部件的间隙来把那条缝隙去除掉
    ...
    def left_UI(self):
        ...
        self.left_close.clicked.connect(qApp.quit)
        self.left_mini.clicked.connect(self.showMinimized)
        self.left_visit.clicked.connect(self.showNormal)
    ...
    def right_UI(self):
        ...
        self.recommend_button_1.setIcon(QIcon('./r1.jpg'))  # 设置按钮图标
        ...
        self.recommend_button_2.setIcon(QIcon('./r2.jpg'))
        ...
        self.recommend_button_3.setIcon(QIcon('./r3.jpg'))
        ...
        self.recommend_button_4.setIcon(QIcon('./r4.jpg'))
        ...
        self.recommend_button_5.setIcon(QIcon('./r5.jpg'))
        ...
        self.playlist_button_1.setIcon(QIcon('./p1.jpg'))
        ...
        self.playlist_button_2.setIcon(QIcon('./p2.jpg'))
        self.playlist_button_2.setIconSize(QSize(100, 100))
        self.playlist_button_2.setToolButtonStyle(Qt.ToolButtonTextUnderIcon)

        self.playlist_button_3 = QToolButton()
        self.playlist_button_3.setText("那些你熟悉又不知道名字…")
        self.playlist_button_3.setIcon(QIcon('./p3.jpg'))
        self.playlist_button_3.setIconSize(QSize(100, 100))
        self.playlist_button_3.setToolButtonStyle(Qt.ToolButtonTextUnderIcon)

        self.playlist_button_4 = QToolButton()
        self.playlist_button_4.setText("那些只听前奏就中毒的英文歌")
        self.playlist_button_4.setIcon(QIcon('./p4.jpg'))
        self.playlist_button_4.setIconSize(QSize(100, 100))
        self.playlist_button_4.setToolButtonStyle(Qt.ToolButtonTextUnderIcon)
