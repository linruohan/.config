...
# 但是对于用户希望能看到多条记录的表来说，就需要使用表格化的视图了。
# 本文通过python3+pyqt5改写实现了python Qt gui 快速变成15章的例子，用户能够一次看到多条记录。
import os
import sys

from PyQt5.QtCore import (PYQT_VERSION_STR, QDate, QFile, QRegExp, QVariant, Qt)
from PyQt5.QtGui import QCursor, QPixmap, QRegExpValidator
...
from PyQt5.QtWidgets import (QApplication, QDateEdit, QDialog, QHBoxLayout, QLabel, QLineEdit, QMessageBox, QPushButton,
