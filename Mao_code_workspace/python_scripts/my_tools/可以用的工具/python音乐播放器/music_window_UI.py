...
class Ui_my_music(object):

    def setupUi(self, my_music):
        my_music.setObjectName("my_music")
        my_music.resize(1200, 650)
        my_music.setMinimumSize(QtCore.QSize(1200, 650))
        my_music.setMaximumSize(QtCore.QSize(1200, 650))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("ico/kk-music.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        my_music.setWindowIcon(icon)
        my_music.setToolTip("")
        self.line = QtWidgets.QFrame(my_music)
        self.line.setGeometry(QtCore.QRect(250, 0, 20, 651))
        self.line.setFrameShape(QtWidgets.QFrame.VLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.gridLayoutWidget = QtWidgets.QWidget(my_music)
        ...
        self.gridLayoutWidget_2 = QtWidgets.QWidget(my_music)
        ...
        self.downloads = QtWidgets.QPushButton(my_music)
        ...
        self.localhost = QtWidgets.QPushButton(my_music)
        ...
        self.logo = QtWidgets.QLabel(my_music)
        ...
        self.myplaylist = QtWidgets.QLabel(my_music)
        ...
        self.new_playlist = QtWidgets.QPushButton(my_music)
        ...
        self.delete_playlist = QtWidgets.QPushButton(my_music)
        ...
        self.add_to_playlist = QtWidgets.QPushButton(my_music)
        ...
        self.layoutWidget = QtWidgets.QWidget(my_music)
        ...
        self.listview = QtWidgets.QListWidget(my_music)
        ...
        self.listview_lable = QtWidgets.QLabel(my_music)
        ...
        self.disc = QtWidgets.QLabel(my_music)
        ...
        self.music_pre = QtWidgets.QPushButton(my_music)
        ...
        self.music_start_stop = QtWidgets.QPushButton(my_music)
        ...
        self.music_next = QtWidgets.QPushButton(my_music)
        ...
        self.message_label = QtWidgets.QLabel(my_music)
        ...
        self.song_modle = QtWidgets.QPushButton(my_music)
        ...
        self.retranslateUi(my_music)
        QtCore.QMetaObject.connectSlotsByName(my_music)

    def retranslateUi(self, my_music):
        _translate = QtCore.QCoreApplication.translate
        my_music.setWindowTitle(_translate("my_music", "Xiaohan-Music"))
        self.title1.setToolTip(_translate("my_music", "单击"))
        self.title5.setToolTip(_translate("my_music", "单击"))
        self.img7.setToolTip(_translate("my_music", "点击下方标题"))
        self.img4.setToolTip(_translate("my_music", "点击下方标题"))
        self.img1.setToolTip(_translate("my_music", "点击下方标题"))
        self.title6.setToolTip(_translate("my_music", "单击"))
        self.img2.setToolTip(_translate("my_music", "点击下方标题"))
        self.img0.setToolTip(_translate("my_music", "点击下方标题"))
        self.title0.setToolTip(_translate("my_music", "单击"))
        self.img5.setToolTip(_translate("my_music", "点击下方标题"))
        self.title4.setToolTip(_translate("my_music", "单击"))
        self.img3.setToolTip(_translate("my_music", "点击下方标题"))
        self.title2.setToolTip(_translate("my_music", "单击"))
        self.title7.setToolTip(_translate("my_music", "单击"))
        self.title3.setToolTip(_translate("my_music", "单击"))
        self.img6.setToolTip(_translate("my_music", "点击下方标题"))
        self.time_pre.setText(_translate("my_music", "00:00"))
        self.time_next.setText(_translate("my_music", "00:00"))
        self.downloads.setToolTip(_translate("my_music", "下载当前播放歌曲"))
        self.localhost.setToolTip(_translate("my_music", "导入本地音乐"))
        self.myplaylist.setText(_translate("my_music", "我的歌单"))
        self.new_playlist.setToolTip(_translate("my_music", "添加歌单"))
        self.delete_playlist.setToolTip(_translate("my_music", "删除歌单"))
        self.add_to_playlist.setToolTip(_translate("my_music", "将当前歌曲添加到歌单中"))
        self.search.setToolTip(_translate("my_music", "在搜索框中搜索"))
        self.search.setText(_translate("my_music", "搜索"))
        self.search_edit.setPlaceholderText(_translate("my_music", "搜索单曲、歌单、歌手"))
        self.src_choose.setToolTip(_translate("my_music", "选择音乐源"))
        self.src_choose.setItemText(0, _translate("my_music", "网易云"))
        self.src_choose.setItemText(1, _translate("my_music", "QQ音乐"))
        self.listview_lable.setText(_translate("my_music", "歌单列表"))
        self.music_pre.setToolTip(_translate("my_music", "上一首"))
        self.music_start_stop.setToolTip(_translate("my_music", "播放/暂停"))
        self.music_next.setToolTip(_translate("my_music", "下一首"))
        self.song_modle.setToolTip(_translate("my_music", "列表循环"))
