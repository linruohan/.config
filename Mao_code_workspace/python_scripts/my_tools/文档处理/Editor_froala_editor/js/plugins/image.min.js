            ...
            t.onload = function () {
                ...
                if (l) {
                    ...
                    for (var i = e.get(0).attributes, n = 0; n < i.length; n++) {
                        var r = i[n];
                        0 === r.nodeName.indexOf("data-") ? e.removeAttr(r.nodeName) : (if (s != null) s.hasOwnProperty(r.nodeName)) && e.removeAttr(r.nodeName)
                    }
                    if (void 0 !== s) {
                        for (t in s) {
                            if (s != null) {
                                s.hasOwnProperty(t) && "link" != t && e.attr("".concat(t), s[t]);
                            }
                        }
                    }
