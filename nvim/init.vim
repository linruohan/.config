...
" SidOfc/mkdx
let $XDG_CONFIG_HOME = "/home/xiaohan/.config"
...
if empty(glob('/home/xiaohan/.config/nvim/_machine_specific.vim'))
	let has_machine_specific_file = 0
	silent! exec "!cp /home/xiaohan/.config/nvim/default_configs/_machine_specific_default.vim /home/xiaohan/.config/nvim/_machine_specific.vim"
endif
...
set visualbell
silent !mkdir -p /home/xiaohan/.config/nvim/tmp/backup
silent !mkdir -p /home/xiaohan/.config/nvim/tmp/undo
"silent !mkdir -p /home/xiaohan/.config/nvim/tmp/sessions
set backupdir=/home/xiaohan/.config/nvim/tmp/backup,.
set directory=/home/xiaohan/.config/nvim/tmp/backup,.
if has('persistent_undo')
	set undofile
	set undodir=/home/xiaohan/.config/nvim/tmp/undo,.
endif
set colorcolumn=100
set updatetime=100
...
" Press ` to change case (instead of /home/xiaohan)
noremap ` /home/xiaohan
...
call plug#begin('/home/xiaohan/.vim/plugged')
...
function! s:check_back_space() abort
	let col = col('.') - 1
	return !col || getline('.')[col - 1]  =/home/xiaohan# '\s'
endfunction
...
" set runtimepath^=/home/xiaohan/.config/nvim/coc-extensions/coc-flutter-tools/
...
" Testing
"if !empty(glob('/home/xiaohan/Github/vim-calc/vim-calc.vim'))
"source /home/xiaohan/Github/vim-calc/vim-calc.vim
"endif
...
function! s:read_template_into_buffer(template)
	...
	execute '0r /home/xiaohan/.config/nvim/sample_vimspector_json/'.a:template
endfunction
command! -bang -nargs=* LoadVimSpectorJsonTemplate call fzf#run({
			\   'source': 'ls -1 /home/xiaohan/.config/nvim/sample_vimspector_json',
			\   'down': 20,
...
if has_machine_specific_file == 0
	exec "e /home/xiaohan/.config/nvim/_machine_specific.vim"
endif
